...
from backend.app.application.schemas.note import NoteCreateRequest, NoteUpdateRequest, NoteResponse
from backend.app.application.services.note_service import NoteService
from backend.app.core.dependencies import get_current_user
from backend.app.infrastructure.db.session import get_db
from backend.app.infrastructure.repositories.note_repository import NoteRepository
