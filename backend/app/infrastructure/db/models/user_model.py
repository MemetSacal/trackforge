...
if TYPE_CHECKING:
    ...
    from backend.app.infrastructure.db.models.note_model import NoteModel
    from backend.app.infrastructure.db.models.meal_compliance_model import MealComplianceModel
    from backend.app.infrastructure.db.models.file_upload_model import FileUploadModel
    ...
    from backend.app.infrastructure.db.models.user_preference_model import UserPreferenceModel
    from backend.app.infrastructure.db.models.shopping_item_model import ShoppingItemModel
    from backend.app.infrastructure.db.models.onboarding_profile_model import OnboardingProfileModel
