...
from backend.app.domain.entities.user_preference import UserPreference
from backend.app.domain.interfaces.i_user_preference_repository import IUserPreferenceRepository
