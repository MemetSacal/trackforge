...
from backend.app.domain.entities.file_upload import FileUpload
from backend.app.domain.interfaces.i_file_upload_repository import IFileUploadRepository
